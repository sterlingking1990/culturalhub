          ...
          <div class="box box-widget">
            <div class="box-header with-border">
              <div class="user-block">
                ...
                <img class="img-circle" src="storage/discussion_images/{{$discussion_detail->profile_pic}}" alt="User Image">
                <?php
            ...
            <div class="box-body">
              ...
              <img class="img-circle" src="storage/discussion_images/{{$discussion_detail->discussion_image}}" alt="Enjoy" style="width: 500px;height: 500px;">
                <?php
...
{{--               <div class="box-comment">
                <!-- User image -->
                <img class="img-circle img-sm" src="{{asset('images/avatar2.png')}}" alt="User Image">
